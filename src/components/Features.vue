...
<template>
    <section class="mx-auto max-w-[1440px] px-5 pb-[60px] text-center lg:px-[136px] lg:pb-[100px]">
        ...
        <ul class="list-none text-center p-0 lg:text-left lg:grid lg:gap-12 lg:grid-cols-3">
            <li class="flex flex-col mb-8 p-0 lg:mb-0">
                <button
                    class="list-option group block relative no-underline text-left font-normal bg-transparent p-0 m-0 border-none transition ease-out duration-300 z-0 cursor-pointer"
                    type="button">
                    <svg width="1em" height="1em" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="inline rounded-[50%] h-[54px] mb-3 w-[54px] lg:mb-5">
                        <path
                            ...
                            fill="url(#Bandage_tsx__a)"></path>
                        <defs>
                            <linearGradient id="Bandage_tsx__a" x1="-0.667" y1="0.333" x2="54.298" y2="57.297"
                                gradientUnits="userSpaceOnUse">
                                <stop stop-color="#75F0F0"></stop>
                                <stop offset="1" stop-color="#7575F0"></stop>
                            </linearGradient>
                        </defs>
                    </svg>
                    <h3
                        class="group-hover:text-[#176293] text-2xl mb-2 mt-[0.444444em] leading-[48px] font-medium lg:text-[31.5px]">
                        Stress less.</h3>
                    <p class="mb-3 mt-3.5 leading-7 text-lg lg:mb-5">Get in-the-moment relief for stress and anxiety so
                        you can get back to living.</p><span data-testid="learnMoreCTA"
                        class="group-hover:text-[#176293] text-lg inline-block font-medium underline">Learn More</span>
                </button>
            </li>
            <li class="flex flex-col mb-8 p-0 lg:mb-0">
                <button
                    ...
                    <svg width="1em" height="1em" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path
                            ...
                            fill="url(#MoonZzz_tsx__a)"></path>
                        <defs>
                            <linearGradient id="MoonZzz_tsx__a" x1="1.333" y1="0.917" x2="56.247" y2="52.835"
                                gradientUnits="userSpaceOnUse">
                                <stop stop-color="#9191FF"></stop>
                                <stop offset="1" stop-color="#F075C7"></stop>
                            </linearGradient>
                        </defs>
                    </svg>
                    <h3
                        class="group-hover:text-[#176293] text-2xl mb-2 mt-[0.444444em] leading-[48px] font-medium lg:text-[31.5px]">
                        Sleep more.</h3>
                    <p class="mb-3 mt-3.5 leading-7 text-lg lg:mb-5">Fall asleep (and stay asleep) naturally and
                        peacefully.</p><span data-testid="learnMoreCTA"
                        class="group-hover:text-[#176293] text-lg inline-block font-medium underline">Learn More</span>
                </button>
            </li>
            <li class="flex flex-col mb-8 p-0 lg:mb-0">
                <button
                    ...
                    <h3
                        ...
                        Live
                        mindfully.</h3>
                    <p class="mb-3 mt-3.5 leading-7 text-lg lg:mb-5">Navigate life's ups and downs with resilience,
                        confidence and guided support.</p><span data-testid="learnMoreCTA"
                        class="group-hover:text-[#176293] text-lg inline-block font-medium underline">Learn More</span>
                </button>
            </li>
        </ul>
...
<style scoped>
.list-option::after {
    border: 2px solid rgb(23, 98, 147);
    border-radius: 20px;
    content: "";
    opacity: 0;
    position: absolute;
